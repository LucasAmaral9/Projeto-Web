...
<% ////////////////////////////
	...
	try{
		c =  (Integer) session.getAttribute("calterarconfirm");
	}
	catch(Exception e){
		c = 0;
	}
		...
		if(c > 0){
			c = 0;
			session.removeAttribute("calterarconfirm"); %> 
			<script type="text/javascript"> ok(); </script>
		<% 
		}
%>

	<h2 style="text-align:center">Alterar Cliente</h2>
	<form method="post" action="ConsultarClienteController" onsubmit="return verificaCPF()">
			
		<fieldset>
		<legend><b>Alterar Cliente</b></legend>
			<div>CPF
